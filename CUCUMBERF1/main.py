...
def agregarProductoAlInventario(inventario):
...
def buscarProductoPorRegistroEnInventario(inventario, registro):
...
def mostrarInventarioDeInventario(inventario):
...
def reducirCantidadProductoEnInventario(inventario, registro, cantidadAReducir):
    producto = buscarProductoPorRegistro(inventario, registro)
    if producto:
...
def agregarCantidadProductoEnInventario(inventario):
...
def eliminarProductoEnInventario(inventario, registro):
    producto = buscarProductoPorRegistro(inventario, registro)
    if producto:
...
def main():
    ...
    while opcion != 7:
        ...
        if opcion == 1:
            agregarProductoAlInventario(inventario)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 2:
            registro = int(input("Ingrese registro del producto a buscar: "))
            buscarProductoPorRegistroEnInventario(inventario, registro)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 3:
            mostrarInventarioDeInventario(inventario)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 4:
            registro = int(input("Ingrese el registro del producto: "))
            cantidad = int(input("Ingrese la cantidad a reducir: "))
            reducirCantidadProductoEnInventario(inventario, registro, cantidad)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 5:
            agregarCantidadProductoEnInventario(inventario)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 6:
            registro = int(input("Ingrese el registro del producto a eliminar: "))
            eliminarProductoEnInventario(inventario, registro)
            input("Presione cualquier tecla para continuar...")
            os.system('cls' if os.name == 'nt' else 'clear')
        elif opcion == 7:
